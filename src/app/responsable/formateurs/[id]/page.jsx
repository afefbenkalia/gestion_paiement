...
export default function FormateurDetailPage() {
  ...
  const fetchFormateurDetails = async () => {
    try {
      ...
      const [userRes, sessionsRes] = await Promise.all([
        ...
        fetch(`/api/responsable/sessions?formateurId=${params.id}`),
      ]);
  ...
  if (!formateur) {
    return (
      <div className="flex flex-col justify-center items-center min-h-screen">
        ...
        <Link href="/responsable/formateurs" className="text-blue-600 hover:underline">
          Retour à la liste
        </Link>
      </div>
    );
  ...
  return (
    <div className="container mx-auto px-6 py-8 max-w-7xl">
      {/* Header */}
      <h1 className="text-3xl font-bold mb-8">Détails du Formateur</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-1">{formateur.name}</h2>
            <p className="text-sm text-gray-500 mb-6">Formateur</p>
            ...
            <div className="w-full space-y-3 mb-6">
              ...
              {formateur.createdAt && (
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  ...
                  <span>Membre depuis {new Date(formateur.createdAt).toLocaleDateString('fr-FR', { month: 'short', year: 'numeric' })}</span>
                </div>
              )}
            </div>
